...
<script>
import Form from "../Card/Form.vue";
import Icons from "../Global/Icons.vue";
export default {
    components: { Icons, Form },
    data: () => ({
